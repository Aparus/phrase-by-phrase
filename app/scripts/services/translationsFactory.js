...
angular.module('booktitresApp')
    ...
    .service('translationsFactory', ['$resource', 'baseURL', function($resource, baseURL) {

        //this.translations = [ { language: "russian", phrases: [] }, { language: "hindi", phrases: [] }] !!!! 
        // or 
